...
//GetProjectsByIDLimit Get Projects By ID Limit
func GetProjectsByIDLimit(c *gin.Context) {
	...
	WHERE 
		...
		and tproject.pd_id = %s order by tproject.drealiz desc limit %s offset %s;`, id, limit, offset)
