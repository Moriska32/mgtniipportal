...
func Orgstructure(c *gin.Context) {
	...
	order by array_position( array ['Директор',
	'Директор по экономике и финансам',
	'Директор по информационным технологиям',
	'Директор по правовому обеспечению деятельности',
	'Заместитель директора по проектам метрополитена',
	'Заместитель директора по организации дорожного движения и специальным проектам',
	'Заместитель директора по городскому наземному электрическому транспорту',
	'Заместитель директора по безопасности',
	'Заместитель директора по инновационным проектам',
	'Заместитель директора по информационно-аналитическим проектам',
	'Заместитель директора по транспортной аналитике и планированию',
	'Заместитель директора - Начальник контрактной службы',
	'Операционный директор-начальник отдела главных инженеров проектов по транспортной аналитике и планированию',
	'Главный инженер',
	'Помощник директора',
	'Пресс-секретарь']::varchar[], name);`
